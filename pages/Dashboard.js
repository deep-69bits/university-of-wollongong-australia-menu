...
const Dashboard = () => {
  ...
  return (
    ...
    <div>
     <img className='w-full lg:h-[300px] h-[200px]' src="https://ik.imagekit.io/cmef8hxb6/3_WA1kRjsQi.jpg?updatedAt=1679424300495" alt="" />

     <div className='my-10 mx-auto px-5 w-full lg:w-1/5 '>
      <h1 className='text-center text-3xl font-serif font-semibold '>Welcome to  I-House </h1>

      <a href="/home"> <button className="mt-5 tracking-wide font-semibold bg-indigo-500 text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
       Menu
      </button></a>

      <a href="/application"> <button className="mt-5 tracking-wide font-semibold bg-indigo-500 text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
       Submit Application
      </button></a>

      <a href="/viewapplication"> <button className="mt-5 tracking-wide font-semibold bg-indigo-500 text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
        View Application
      </button></a>
