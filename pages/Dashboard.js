      ...
      <div>
        ...
        <div className='my-10 mx-auto px-5 w-full lg:w-2/5 '>
          ...
          <div className='w-full  lg:w-1/3 m-auto block justify-between'>
            ...
            <a href="/application" className='w-full mx-4'> <button className="mt-5 tracking-wide font-semibold bg-indigo-500 text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
              Apply Late Meal
            </button></a>
