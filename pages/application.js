...
const application = () => {
    ...
    const deletedoc= async(e)=>{
        toast("You deleted application successfully");
        setTimeout(function(){router.push('/')}, 3000);
        
        const docref= await deleteDoc(doc(db, "Users", user.email));
        if(docref){
        }
    }
            ...
            <nav className="border-gray-200 bg-white px-2 py-5 shadow-2xl">
                <div className="container mx-auto flex flex-wrap items-center justify-between">
                    ...
                    <div className="hidden md:flex justify-between items-center w-full md:w-auto md:order-1" id="mobile-menu-3">
                        ...
                        <li>
                        <a href="/Dashboard" className="text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 flex pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0" aria-current="page">
                          <svg width="30px" height="17px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          Home
                            ...
                            <li>
                                <a href="/application" className="text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 flex pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0"><svg width="30px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h1 className='my-4 font-bold text-2xl mt-10  text-center'>Late meal form </h1>
            {
                ...
                <div>
                    <div className="overflow-hidden shadow-xl sm:rounded-md ">
                        ...
                        {
                            check? <button onClick={deletedoc} className="mt-5 tracking-wide font-semibold bg-indigo-500 text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">Delete</button>:<div></div>
                        }
                    </div>
                    </div>
                    </div>
